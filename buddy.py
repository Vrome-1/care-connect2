...
def buddy():
  ...
  Buddies = {'Cancer': ['Alice: At 34, I never expected to face breast cancer, but after my diagnosis last year, I discovered a strength I didn’t know I had. Now that I’m on the other side, I want to share my journey through my blog to help others find hope. I’m eager to connect with someone who’s currently facing this challenge and offer my support.', 'Ben: As a school teacher, I’ve always believed in the power of laughter, which helped me immensely during my battle with stage 2 colon cancer. Now, at 45, I’m ready to share my experiences and the lighter moments from my journey. I’m looking to connect with someone who could use a buddy to help navigate this tough road.', 'Jaspreet: Art has always been my refuge, and it became even more important during my fight with ovarian cancer. I’m Jaspreet, 28, and now that I’ve come through it, I’m passionate about using my art to inspire others. I’m hoping to connect with someone who needs encouragement and a friend to share their story.', 'Donald: Having served as a veteran, I thought I had faced my toughest battles. Then I was diagnosed with prostate cancer at 60. Now that I’m in recovery, I want to give back by sharing what I’ve learned about resilience and mental strength. I’m here to support someone who’s currently navigating their journey.', 'June: As a grandmother, I’ve always cherished family moments, but my lung cancer diagnosis changed my perspective on life. At 50, I’ve learned the importance of community and support. I want to connect with someone who’s going through a similar experience, offering both practical advice and emotional support as a fellow survivor.'] , 'Depression': ['Bernard', 'Andrew', 'Melaina', 'Carl'], 'Diabetes': ['Delian', 'Sally'], 'Eating Disorder': ['Dennis', 'Julia']}
